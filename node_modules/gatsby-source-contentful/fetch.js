  ...
  const contentfulClientOptions = {
    ...
    responseLogger: response => {
      ...
      if (response.isAxiosError) {
        ...
        if ((_response$response = response.response) === null || _response$response === void 0 ? void 0 : (_response$response$da = _response$response.data) === null || _response$response$da === void 0 ? void 0 : _response$response$da.message) {
